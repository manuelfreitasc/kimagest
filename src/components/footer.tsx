        ...
        <footer className="py-16 md:py-32 bg-[#091426]">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    ...
                    <Link href="#" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-muted hover:text-primary block">
                        <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                    ...
                    <Link href="#" target="_blank" rel="noopener noreferrer" aria-label="Threads" className="text-muted hover:text-primary block">
                        <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                    ...
                    <Link href="#" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted hover:text-primary block">
                        <svg className="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                            <path
                                fill="currentColor"
